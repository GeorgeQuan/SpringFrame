namespace Config
{
    public class ConfigManager
    {
        public ConfigManager()
        {
            ...
            Newtonsoft.Json.Utilities.AotHelper.EnsureList<SevenLogin>();
            Newtonsoft.Json.Utilities.AotHelper.EnsureList<ShopConfig>();
            Newtonsoft.Json.Utilities.AotHelper.EnsureList<I18NConfig>();
            Newtonsoft.Json.Utilities.AotHelper.EnsureList<sevendaylogin>();
            Newtonsoft.Json.Utilities.AotHelper.EnsureList<PacksItem>();
            Newtonsoft.Json.Utilities.AotHelper.EnsureList<Packs>();
            Newtonsoft.Json.Utilities.AotHelper.EnsureList<SkilAtk>();
            Newtonsoft.Json.Utilities.AotHelper.EnsureList<Duanzao>();
            Newtonsoft.Json.Utilities.AotHelper.EnsureList<SkilDeail>();
        ...
        public static void LoadAllConfigsByAddressable(string directory)
        {
            ...
            Config.SevenLogin.DeserializeByAddressable(directory);
            Config.ShopConfig.DeserializeByAddressable(directory);
            Config.I18NConfig.DeserializeByAddressable(directory);
            Config.sevendaylogin.DeserializeByAddressable(directory);
            Config.PacksItem.DeserializeByAddressable(directory);
            Config.Packs.DeserializeByAddressable(directory);
            Config.SkilAtk.DeserializeByAddressable(directory);
        ...
        public static void LoadAllConfigsByFile(string directory)
        {
            ...
            Config.SevenLogin.DeserializeByFile(directory);
            Config.ShopConfig.DeserializeByFile(directory);
            Config.I18NConfig.DeserializeByFile(directory);
            Config.sevendaylogin.DeserializeByFile(directory);
            Config.PacksItem.DeserializeByFile(directory);
            Config.Packs.DeserializeByFile(directory);
            Config.SkilAtk.DeserializeByFile(directory);
        ...
        public static System.Collections.IEnumerator LoadAllConfigsByBundle(string directory, string subFolder)
        {
            ...
            yield return Config.SevenLogin.DeserializeByBundle(directory, subFolder);
            ...
            yield return Config.sevendaylogin.DeserializeByBundle(directory, subFolder);
            yield return Config.PacksItem.DeserializeByBundle(directory, subFolder);
            yield return Config.Packs.DeserializeByBundle(directory, subFolder);
            yield return Config.SkilAtk.DeserializeByBundle(directory, subFolder);
            yield return Config.Duanzao.DeserializeByBundle(directory, subFolder);
            yield return Config.SkilDeail.DeserializeByBundle(directory, subFolder);
        }
    }
}
