    ...
    public partial struct sevendaylogin
    {
        public static void DeserializeByAddressable(string directory)
        {
            ...
            for (int i = 0; i < array.Count; i++)
            {
                ...
                sevendaylogin data = (sevendaylogin)dataObject.ToObject(typeof(sevendaylogin));
                datas.Add(data);
        ...
        {
            string bundleName = $"{subFolder}/sevendaylogin.bytes".ToLower();
        ...
        private static List<sevendaylogin> datas;
        private static Dictionary<int, int> indexMap;
        public static sevendaylogin ByID(int id)
        {
            if (id <= 0)
            {
                return Null;
            ...
            {
                throw new System.Exception($"sevendaylogin找不到ID:{id}");
            }
            return ByIndex(index);
        }
        public static sevendaylogin ByIndex(int index)
        {
            return datas[index];
        }
        public bool IsNull { get; private set; }
        public static sevendaylogin Null { get; } = new sevendaylogin() { IsNull = true }; 
        public System.Int32 ID { get; set; }
        public string Description { get; set; }
        public string show_money { get; set; }
        public string reward_text { get; set; }
        public string show_dec1 { get; set; }
        public string show_item { get; set; }
        public string path { get; set; }
        public string day_picture { get; set; }
        public System.Single show_model { get; set; }
        public System.Single position_x_1 { get; set; }
        public System.Single position_y_1 { get; set; }
        public System.Single position_z_1 { get; set; }
        public System.Single scale_1 { get; set; }
        public System.Single model_position_x_1 { get; set; }
        public System.Single model_position_y_1 { get; set; }
        public System.Single model_position_z_1 { get; set; }
        public System.Single model_scale_1 { get; set; }
    }
}
