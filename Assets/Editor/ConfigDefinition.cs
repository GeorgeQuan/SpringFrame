...
击倒=Lua\Effect\knock_down；持续时间")]
    ...
    public class sevendaylogin
    {
        ...
        public float show_model { get; set; }
        public float position_x_1 { get; set; }
        public float position_y_1 { get; set; }
        public float position_z_1 { get; set; }
        public float scale_1 { get; set; }
        public float model_position_x_1 { get; set; }
        public float model_position_y_1 { get; set; }
        public float model_position_z_1 { get; set; }
        public float model_scale_1 { get; set; }
    }
    [ExcellentConfig]
    [Serializable]
    ...
    public class Packs
    {
        ...
        public int bing1 { get; set; }
        public int rate1 { get; set; }
        public string name2 { get; set; }
        public int num2 { get; set; }
        public int bing2 { get; set; }
        public int rate2 { get; set; }
        public string name3 { get; set; }
        public int num3 { get; set; }
        public int bing3 { get; set; }
        public int rate3 { get; set; }
        public string name4 { get; set; }
        public int num4 { get; set; }
        public int bing4 { get; set; }
        public int rate4 { get; set; }
        public string name5 { get; set; }
        public int num5 { get; set; }
        public int bing5 { get; set; }
    ...
    {
        public int skill_use_type { get; set; }
        public string skill_name { get; set; }
        public int skill_icon { get; set; }
        ...
        public int can_move { get; set; }
        public int blood_delay { get; set; }
    ...
    [ExcellentConfig]
    [Serializable]
    public class Duanzao
    {
        public string equip_strength_level { get; set; }
        public int stuff_count { get; set; }
        public int fangyu {  get; set; }    
        public int per_pvp { get; set; }
    }
    [ExcellentConfig]
    [Serializable]
    public class SkilDeail
    {
        public int fix_hurt { get; set; }
        public int coin_cost { get; set; }
        public int capbility { get; set; }
    }
}
